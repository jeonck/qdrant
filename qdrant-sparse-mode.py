...
# 컬렉션 이름 설정
collection_name = "movies_sparse"
 
# Qdrant 벡터 저장소 생성 (Sparse mode)
qdrant_sparse = QdrantVectorStore.from_documents(
    ...
    sparse_vector_name="bm25_sparse",  # 희소 벡터 이름 지정
)
...
query = "액션 영화 추천해주세요"
found_docs = qdrant_sparse.similarity_search_with_score(query)
